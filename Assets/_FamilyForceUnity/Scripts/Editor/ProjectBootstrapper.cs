...
namespace FamilyForceUnity.Editor
{
    public static class ProjectBootstrapper
    {
        ...
        private const string EnemySheetPath = Root + "/Art/Generated/Enemies/family-force-enemy-models-family-safe-defringed-v4.png";
        ...
        private static void ConfigureProject()
        {
            ...
            PlayerSettings.bundleVersion = "0.40.2";
